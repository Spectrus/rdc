...
export class DetailController {
 ...
 update(dt:number,moving:boolean,ready:boolean):number {
  ...
  const fixed=this.mode==='ultra'?8_000_000:6_000_000;
  const desired=this.mode==='auto'?(this.idleTime>1.25?Math.max(this.motionBudget,this.mobile?3_000_000:5_000_000):this.motionBudget):fixed;
