(function (global) {
  ...
  function documentHtml(options, resolveAsset = asset) {
    return '<!doctype html><html lang="pt-BR"><head><meta charset="utf-8"><meta name="viewport" content="width=device-width,initial-scale=1"><style type="text/css">.bc-cta-link:hover,.bc-cta-link:focus{color:#fffaf0!important;background-color:#513322!important;}</style></head><body style="margin:0;padding:0">' + render(options, resolveAsset) + '</body></html>';
  }
